...
const checkDogs = function (dogsJulia, dogsKate) {
  ...
  allDogs.forEach(function (age, i, arr) {
    if (age > 3) {
      console.log(
        `%c Dog number ${i + 1} is an adult, and is ${age} years old`,
        'font-size: 20px; color: green;'
      );
    } else {
      console.log(
        `%c Dog number ${i + 1} is still a puppy 🐶`,
        'font-size: 20px; color: green;'
      );
    }
  });
...
// 8.
const ascending = dogs.slice().sort((a, b) => a.recFood - b.recFood);
